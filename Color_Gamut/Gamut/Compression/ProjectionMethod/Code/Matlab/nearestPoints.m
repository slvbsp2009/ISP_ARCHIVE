...
plot(x(1),y(1),'Marker','x', 'Color', 'white', 'LineWidth', 2)  

[flag, xl, yl] = nearest_longline(x(1), y(1)) 

plot(xl, yl, 'Marker', 's', 'Color', 'white', 'LineWidth', 2) 
...
line([xlong(1), xlong(2)], [ylong(1), ylong(2)], 'LineStyle', '--', 'Color', 'white', 'LineWidth', 2) 

[xi,yi] = polyxpoly(xuhd, yuhd, xlong, ylong); 
plot(xi,yi,'Marker','o', 'Color', 'white', 'LineWidth', 2) 

[xi,yi] = polyxpoly(xhd, yhd, xlong, ylong); 
plot(xi,yi,'Marker','o', 'Color', 'white', 'LineWidth', 2) 
