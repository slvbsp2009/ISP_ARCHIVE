/**
 * @file dmmalvarcli.c 
 * @brief Malvar-He-Cutler demosaicing command line program
...
{
    printf("Malvar-He-Cutler demosaicing demo, P. Getreuer 2010-2011\n\n");
    printf("Usage: dmmalvar [options] <input file> <output file>\n\n"
...
#endif
    printf("Example:\n"
        "   dmmalvar -p RGGB frog.bmp frog-dm.bmp\n");
}
...
int main(int argc, char *argv[])
{
    ...
    /* Perform demosaicing */
    MalvarDemosaic(Output, Input, Width, Height, Param.RedX, Param.RedY);
